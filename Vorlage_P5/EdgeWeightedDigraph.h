...
public:
	...
	DirectedEdge(int from, int to, double weight) : _from{from}, _to{to}, _weight{weight}
	{
	}
...
public:
	...
	std::vector<DirectedEdge> getAdj(int v) const;		   // liefert Vector der adjazenten Kanten zu v
