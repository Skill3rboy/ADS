...
public:
	Edge(int either, int other, double weight) : _either{either}, _other{other}, _weight{weight}
	{
	}
...
public:
	...
	std::vector<Edge> getAdj(int v) const; // liefert Vector der adjazenten Kanten zu v
